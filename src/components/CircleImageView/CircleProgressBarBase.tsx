...
const CircleProgressBarBase = (props: CircleProgressBarBaseProps) => {
    const {percentage, speed, className, trailStrokeColor, trailStrokeWidth, trailSpaced, strokeColor, strokeWidth, innerText, legendText} = props;
